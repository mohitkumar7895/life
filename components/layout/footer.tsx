...
export default function Footer() {
  return (
    <footer className="bg-[#17231D] text-[#FAF7EF] pt-8 pb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#68746C] max-w-sm">
              Learn. Improve. Stay Consistent. Live Fit.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'About Us', 'Wellness Goals', 'Community', 'FAQ', 'Contact'].map((item) => (
                <li key={item}>
          ...
          <div>
            <h4 className="font-heading text-lg text-white mb-4">Customer Care</h4>
            <ul className="space-y-2">
          ...
          <div>
            ...
            <p className="text-[#68746C] mt-4 text-xs">
              Products displayed are intended for general wellness and are not a substitute for professional medical advice.
            </p>
          </div>
        </div>

        <div className="border-t border-[#174A3A]/50 pt-4 flex flex-col md:flex-row items-center justify-between text-xs md:text-sm text-[#68746C]">
          <p>© {new Date().getFullYear()} FitLife Wellness. All Rights Reserved.</p>
